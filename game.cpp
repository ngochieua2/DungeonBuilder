...
void Game::createExampleLevel(){
    ...
    //Build an open way door in the East of room 1 and an open way door in the West of room 2
    ...
    //Build a block door way in the East of room 2 and a block door way in the West of room 3
    ...
    //Build an one way door in the South of room 1 and an one way door in the North of room 4
    ...
    //Build an open-way door in the South of room 2 and an open door way in the North of room 5
    ...
    //Build an open-way door in the South of room 3 and locked door way in the North of room 6
    ...
    //Build an open door way in the East of room 5 to the West of room 6
    _builder->builDoorway(dungeon->retrieveRoom(5),dungeon->retrieveRoom(6),
                          Room::Direction::East,static_cast<DungeonLevelBuilder::MoveConstraints>(0));
    //Build a blocked door way in the South of room 4 and the North of room 7
